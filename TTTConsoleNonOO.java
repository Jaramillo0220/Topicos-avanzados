...
public class TTTConsoleNonOO {
   ...
   public static void main(String[] args) {
      do {
          // Inicializa el juego antes de cada partida
          initGame();
          ...
          do {
              ...
              // Refresca el tablero
              paintBoard();
              // Muestra el mensaje si el juego ha terminado
          ...
          } while (currentState == PLAYING); // repetir si el juego no ha terminado
      ...
      } while (true);  // repite hasta que el usuario responda algo distinto a 'y' o 'Y'
  }
